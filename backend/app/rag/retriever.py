...
_RED_FLAG_PATTERNS: list[tuple[str, str]] = [
    ...
    ("rebound tenderness",   "Rebound tenderness may indicate a surgical emergency."),
    ("rebound pain",         "Rebound tenderness may indicate a surgical emergency."),
...
_KEYWORD_WEIGHTS: list[tuple[list[str], GutCondition, float]] = [
    ...
    (["bloated", "bloating", "full", "distended", "gas pain", "gassy", "trapped wind", "flatulence"],

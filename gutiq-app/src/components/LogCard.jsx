...
export default function LogCard({ log, delay = 0 }) {
  ...
  const sevColor = getSeverityColor(log.parsed_severity);
  ...
  return (
    ...
    >
      ...
      <div style={{ height: 4, borderRadius: 999, backgroundColor: COLORS.surfaceAlt, marginBottom: 10, overflow: 'hidden' }}>
        <div style={{ height: '100%', width: `${log.parsed_severity * 10}%`, backgroundColor: sevColor, borderRadius: 999, transition: 'width 0.4s ease' }} />
      </div>
